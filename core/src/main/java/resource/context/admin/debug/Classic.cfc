...
<cfoutput>
	<pre><b> Query Parameter Value(s) - </b><br><br><cfloop from="1" to="#arraylen(queries.paramValue)#" index="i">###i# Parameter(#queries.paramType[queries.currentrow][i]#) = #queries.paramValue[queries.currentrow][i]#<br></cfloop></pre>
</cfoutput>
</cfif>
</cfloop>
</cfif>
