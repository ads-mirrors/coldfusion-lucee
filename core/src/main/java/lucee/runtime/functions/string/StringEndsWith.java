 ...
 */
public final class StringEndsWith extends BIF {

	public static boolean call(PageContext pc, String input, String subs, boolean ignoreCase) {

		if (ignoreCase) return input.regionMatches(true, input.length() - subs.length(), subs, 0, subs.length());
	...
	public Object invoke(PageContext pc, Object[] args) throws PageException {
		...
		if (args.length < 2 || args.length > 3) throw new FunctionException(pc, "endsWith", 2, 3, args.length);
