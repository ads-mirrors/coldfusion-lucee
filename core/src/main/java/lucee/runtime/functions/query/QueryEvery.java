...
public final class QueryEvery extends BIF {

	private static final long serialVersionUID = -9206289776586881074L;
	...
	public static boolean call(PageContext pc, Query qry, UDF udf, boolean parallel, Number maxThreads) throws PageException {
	...
	public Object invoke(PageContext pc, Object[] args) throws PageException {
		...
		throw new FunctionException(pc, "QueryEvery", 2, 4, args.length);
