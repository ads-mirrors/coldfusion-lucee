...
public final class UndefinedImpl extends StructSupport implements Undefined, Objects {
	...
	public void initialize(PageContext pc, short type, boolean debug) {
		logCascadingWrite = LOG_CASCADING_WRITE_LOG != null ? LogUtil.does(((PageContextImpl) pc).getLog(LOG_CASCADING_WRITE_LOG, false), LOG_CASCADING_WRITE_LOG_LEVEL) : false;
